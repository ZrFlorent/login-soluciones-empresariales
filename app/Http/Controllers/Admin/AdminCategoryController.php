...
class AdminCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // $categorias = Category::where('nombre','like','%$nombre%')->OrderBy('nombre')->paginate(2);
        return view('adminatir.category.index', compact('categorias'));
    ...
    {
        return view('adminatir.category.create'); 
    ...
    public function show($slug)
    {
        ...
        $editar = 'Si';
        return view('adminatir.category.show', compact('cat', 'editar')); 
    }
    ...
    public function edit($slug)
    {
        $cat = Category::where('slug', $slug)->firstOrFail();
        $editar = 'Si';
        return view('adminatir.category.edit', compact('cat', 'editar')); 
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //return $cat;
        return redirect()->route('admin.category.index')->with('datos','Registro modificado correctamente');
