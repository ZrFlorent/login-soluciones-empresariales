            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label>Nombre</label>
                  <input @blur="getProduct" @focus="div_aparecer= false" v-model="nombre" type="text"
              ...
              <div class="col-sm-6">
                    ...
                    <div class="form-group clearfix">
                      <div class="custom-control custom-checkbox">
                        <input @if ($producto->activo=="Si") checked @endif type="checkbox" class="custom-control-input" id="activo" name="activo">
                        
                        <label class="custom-control-label" for="activo">¿Esta activo?</label>
                     </div>
       ...
       <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                   ...
                   <input type="submit" :disabled="deshabilitar_boton==1" value="Guardar" class="btn btn-primary">
