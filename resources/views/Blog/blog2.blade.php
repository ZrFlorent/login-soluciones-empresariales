    ...
    <section class="about-section" id="nuevo">
        <div class="container">
            ...
            <p class="parrafos-nosotros">Comprometidos con nuestros clientes para crear soluciones integrales, únicas y
                bío-tecnológicas de larga duración, no invasivas. <br> Contamos con geles, sanitizantes y plata coloidal.
            </p>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex color-contenedor2">
                    <div class="about-img">
                        <img class="img-fluid" src="../img/productos/image157.png" alt="image-landing">
                    </div>
                </div>
                <div class="col-lg-6 order-first order-lg-first">
                    <div class="section-title">
                        <h2 class="title">Dentífrico Líquido </h2>
                        <h5 class="subtitle">Formula auxiliar en la limpieza y cuidado bucal </h5>
                    </div>
                    <div class="about-content">
                        <p>Descripcion del producto</p>
                        <ul class="list-unstyled">
                            <li class=""> <i class="fas fa-check"></i> Menta + Bicarbonato de sodio + Fluoruro de sodio.
                            <li class=""><i class="fas fa-check"></i> Peróxido de Hidrógeno + Aceite de Neem </li>
                            </li>
                            <li class=""><i class="fas fa-check"></i> Elaborado a base de ingredientes naturales que han
                                sido usados por odontólogos para facilitar el blanqueo, brillantado y desinfección de
                                dientes y boca.</li>
